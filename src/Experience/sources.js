export default [
    ...
    // smallScreen1 carousel (6 personal photos)

    { name: 'smallScreenOne1', type: 'texture', path: 'textures/screens/smallScreen1/1.jpg' },
    { name: 'smallScreenOne2', type: 'texture', path: 'textures/screens/smallScreen1/2.jpg' },
    { name: 'smallScreenOne3', type: 'texture', path: 'textures/screens/smallScreen1/3.jpg' },
    { name: 'smallScreenOne4', type: 'texture', path: 'textures/screens/smallScreen1/4.jpg' },
    { name: 'smallScreenOne5', type: 'texture', path: 'textures/screens/smallScreen1/5.jpg' },
    { name: 'smallScreenOne6', type: 'texture', path: 'textures/screens/smallScreen1/6.jpg' },

    // smallScreen2 carousel (5 personal photos)

    { name: 'smallScreenTwo1', type: 'texture', path: 'textures/screens/smallScreen2/1.jpg' },
    { name: 'smallScreenTwo2', type: 'texture', path: 'textures/screens/smallScreen2/2.jpg' },
    { name: 'smallScreenTwo3', type: 'texture', path: 'textures/screens/smallScreen2/3.jpg' },
    { name: 'smallScreenTwo4', type: 'texture', path: 'textures/screens/smallScreen2/4.jpg' },
    { name: 'smallScreenTwo5', type: 'texture', path: 'textures/screens/smallScreen2/5.jpg' },
