...
export default class RayCaster
{
    constructor()
    {
        ...
        this.preLoader.on('start', () =>
        {
            ...
            this.easelHitBox = new THREE.Mesh(
                new THREE.BoxGeometry( 0.4, 1, 1 ),
                this.hitBoxMaterial
            )
            this.easelHitBox.position.set(-4,-0.4,-4.72)
            ...
            this.signHitBoxes.add(this.projectsHitBox, this.easelHitBox, this.articlesHitBox,this.aboutMeHitBox, this.creditsHitBox )
            ...
            // Layout = 4 columns x 2 rows (matches the visible capsule cards in Materials.js)
            this.projectHitBoxGeometry = new THREE.PlaneGeometry( 0.21, 0.33 )
            ...
            this.project1 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project1.position.set(_col0, _row0, _z)

            this.project2 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project2.position.set(_col1, _row0, _z)

            this.project3 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project3.position.set(_col2, _row0, _z)

            this.project4 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project4.position.set(_col3, _row0, _z)

            this.project5 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project5.position.set(_col0, _row1, _z)

            this.project6 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project6.position.set(_col1, _row1, _z)

            this.project7 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project7.position.set(_col2, _row1, _z)

            this.project8 = new THREE.Mesh(this.projectHitBoxGeometry, this.hitBoxMaterial)
            this.project8.position.set(_col3, _row1, _z)

            this.projectNavigateHitBoxGeometry = new THREE.PlaneGeometry( 0.62, 0.25 )

            this.projectBack = new THREE.Mesh(
                this.projectNavigateHitBoxGeometry,
                this.hitBoxMaterial
            )
            this.projectBack.position.set(0.93,-1.62,2.85)
            ...
            this.projectHitBoxes.add(this.project1, this.project2, this.project3, this.project4, this.project5, this.project6, this.project7, this.project8, this.projectBack)
            ...
            if(this.debug.active)
            {
                ...
                this.debugFolder
                    ...
                    .onChange(() =>
                    {
                        ...
                        this.easelHitBox.visible = this.hitBoxVisibility.visible
            ...
            this.objectsToTest = [
                ...
                this.ramenShop.easelSignBlack, this.ramenShop.easelSignPink, this.ramenShop.easelFrontGraphic,
                ...
                this.ramenShop.greenSignSquare, this.ramenShop.greenSquareCredits,
                this.ramenShop.skillsLabelText, this.ramenShop.skillsSignPlate,
    ...
    click(cursor)
    {
        ...
        if(this.controller.logic.mode === 'skillsLanding' || this.controller.logic.mode === 'credits' || this.controller.logic.mode === 'skillDetail')
        {
            const arcadeIntersects = this.raycaster.intersectObject(this.ramenShop.arcadeScreen)
            if(arcadeIntersects.length)
            {
                this.controller.screenControls.arcadeScreen(arcadeIntersects[0].uv)
                return
            }
        }
        
        //Object click listener
        // Filter out any undefined entries (meshes that were removed from the GLTF)
        this.intersectsObjects = this.raycaster.intersectObjects(this.objectsToTest.filter(o => o))
        if(this.intersectsObjects.length)
        {
            ...
            switch(this.selectedModel)
            {
                ...
                case this.ramenShop.easelSignBlack:
                case this.ramenShop.easelSignPink:
                case this.ramenShop.easelFrontGraphic:
                case this.easelHitBox:
                    this.controller.menuControls.easelBoard(this.ramenShop.easelSignBlack, 'black')
                    break
                ...
                case this.ramenShop.greenSignSquare:
                case this.ramenShop.greenSquareCredits:
                case this.creditsHitBox:
                    // Flash the "credits" black text white for click feedback
                    if(this.controller.menuControls && this.controller.menuControls.flashColor)
                        this.controller.menuControls.flashColor(this.ramenShop.greenSquareCredits, 0xffffff, 0x000000, 250)
                    this.controller.menuControls.easelBoard(this.ramenShop.easelSignBlack, 'black')
                    break

                case this.ramenShop.skillsLabelText:
                case this.ramenShop.skillsSignPlate:
                    this.controller.menuControls.credits(this.ramenShop.skillsLabelText, 'black')
                    break
                ...
                case this.ramenShop.arcadeScreen:
                    this.controller.screenControls.arcadeScreen(this.intersectsObjects[0].uv)
                    break
        ...
        //Object click listener
        this.intersectsMachines= this.raycaster.intersectObjects(this.machinesToTest.filter(o => o))
        if(this.intersectsMachines.length)
        {
            ...
            switch(this.selectedMachine)
            {
                ...
                case this.ramenShop.bigScreen:
                    this.controller.screenControls.bigScreen(this.intersectsMachines[0].uv)
                    break
            }
        }
    }
